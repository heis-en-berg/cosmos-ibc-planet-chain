...
import HeisEnBergPlanetHeisenbergPlanetBlog from './heis-en-berg/planet/heisenberg.planet.blog'
...
export default { 
  ...
  HeisEnBergPlanetHeisenbergPlanetBlog: load(HeisEnBergPlanetHeisenbergPlanetBlog, 'heisenberg.planet.blog'),
