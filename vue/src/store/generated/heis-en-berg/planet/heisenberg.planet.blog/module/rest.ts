...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/heis-en-berg/planet/blog/post
   */
  queryPostAll = (
    query?: {
    ...
    this.request<BlogQueryAllPostResponse, RpcStatus>({
      path: `/heis-en-berg/planet/blog/post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/heis-en-berg/planet/blog/sentPost
   */
  querySentPostAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryAllSentPostResponse, RpcStatus>({
      path: `/heis-en-berg/planet/blog/sentPost`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/heis-en-berg/planet/blog/timedoutPost
   */
  queryTimedoutPostAll = (
    ...
    this.request<BlogQueryAllTimedoutPostResponse, RpcStatus>({
      path: `/heis-en-berg/planet/blog/timedoutPost`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
